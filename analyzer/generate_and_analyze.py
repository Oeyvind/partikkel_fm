...
delays = [0.17,0.19,0.2,0.23,0.25,0.33,0.4,0.45,0.47,0.49,0.5,0.6,0.66,0.7,0.75,0.77,0.8,1.25]#[0.17,0.19,0.2,0.23,0.25,0.33,0.4,0.45,0.47,0.49,0.5,0.6,0.66,0.75,0.77,0.8,1.25]#np.around(np.arange(0.47,0.8,0.03),2).tolist()
