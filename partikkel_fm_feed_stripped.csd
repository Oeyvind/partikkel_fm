...
<CsInstruments>
  ...
  ksustain_amount = 0.5 ; sustain time (relative) in each grain
  ifm_index = 1
  kfm_index linseg 0, 1, 0, p3-2, ifm_index, 1, ifm_index
  kfeed_delay = 0.5 ; feedback delay time (phase synced)
