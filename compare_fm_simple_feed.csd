...
-ocompare_fm_simple_feed.wav      ; output to audio file
</CsOptions>
<CsInstruments>
...
; filtering of feedback signal
  ...
  if khpfilterfq > 0.1 then
    amod butterhp amod, khpfilterfq
...
; audio out
 outs acar*iamp, acar*iamp;mod/(kmodindex*icps)
endin
