...
instr 1
  ...
  igrainrate1 = p5
  igrainrate2 = p6
  kgrainrate line igrainrate1, p3, igrainrate2
  imodindex_start = p7
  imodindex_end = p8
  kmodindex line imodindex_start, p3, imodindex_end
  ifeed_delay1 = p9 ; feedback delay time (phase synced)
  ifeed_delay2 = p10
  kfeed_delay line ifeed_delay1, p3, ifeed_delay2
  ilpfilterfq1 = p11; bypass filter if cutoff above 20k
  ilpfilterfq2 = p12
  klpfilterfq line ilpfilterfq1, p3, ilpfilterfq2
  ihpfilterfq1 = p13 ; bypass filter if cutoff lower than 0.1
  ihpfilterfq2 = p14
  khpfilterfq line ihpfilterfq1, p3, ihpfilterfq2
  iam_stabilizer = p15 ; switch for AM in feedback
  ...
  igrainpitch1 = p16
  igrainpitch2 = p17
  kgrainpitch line igrainpitch1, p3, igrainpitch2
  igraindur1 = p18
  igraindur2 = p19
  kgraindur line igraindur1, p3, igraindur2
  ka_d_ratio = p20 ; attack time (relative) for each grain
  ksustain_amount = p21 ; sustain time (relative) in each grain
  kindex_mapping = p22 ; apply index adjustment formula 
  kinvphase2 = p23 ; invert phase of every 2nd grain
